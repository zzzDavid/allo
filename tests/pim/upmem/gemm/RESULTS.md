...
- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for output (max_abs_err=1.90735e-06, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/gemm.py::gemm_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
...
- timestamp: 2026-07-01T09:39:29.381134
