...
- reference: examples/polybench/cholesky.py::cholesky_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'N': 120}
- cycles: 408148665
- source: `upmem_cost@1e9f869de726a65f (analytical MLIR operation graph); portable-C functional oracle`
- run_cmd: `python -m pytest tests/pim/upmem/cholesky/test_cholesky_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:21.415383
