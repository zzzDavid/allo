...
- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for q, s (max_abs_err=0, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/bicg.py::bicg_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'M': 116, 'N': 124}
- cycles: 609371
...
- timestamp: 2026-07-01T09:39:20.851929
