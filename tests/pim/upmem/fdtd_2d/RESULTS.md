# fdtd_2d on upmem (SMALL)

- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for ex, ey, hz (max_abs_err=0, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/fdtd_2d.py::fdtd_2d_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
...
- run_cmd: `python -m pytest tests/pim/upmem/fdtd_2d/test_fdtd_2d_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:25.648193
