# jacobi_2d on upmem (SMALL)

- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for A, B (max_abs_err=5.96046e-08, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/jacobi_2d.py::jacobi_2d_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'TSTEPS': 40, 'N': 90}
- cycles: 265598
- source: `upmem_cost@1e9f869de726a65f (analytical MLIR operation graph); portable-C functional oracle`
- run_cmd: `python -m pytest tests/pim/upmem/jacobi_2d/test_jacobi_2d_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:33.650546
