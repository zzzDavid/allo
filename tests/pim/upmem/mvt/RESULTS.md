...
- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for x1_out, x2_out (max_abs_err=0, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/mvt.py::mvt_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'N': 120}
- cycles: 609482
...
- timestamp: 2026-07-01T09:39:35.453131
