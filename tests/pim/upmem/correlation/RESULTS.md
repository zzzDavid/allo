# correlation on upmem (SMALL)

- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for corr (max_abs_err=1.04308e-07, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/correlation.py::correlation_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'M': 80, 'N': 100}
- cycles: 2507474
- source: `upmem_cost@1e9f869de726a65f (analytical MLIR operation graph); portable-C functional oracle`
- run_cmd: `python -m pytest tests/pim/upmem/correlation/test_correlation_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:22.180306
