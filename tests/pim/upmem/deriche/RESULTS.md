# deriche on upmem (SMALL)

- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for imgOut, y1, y2 (max_abs_err=6.70552e-07, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/deriche.py::deriche_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'W': 192, 'H': 128}
- cycles: 1856943
- source: `upmem_cost@1e9f869de726a65f (analytical MLIR operation graph); portable-C functional oracle`
- run_cmd: `python -m pytest tests/pim/upmem/deriche/test_deriche_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:23.754772
