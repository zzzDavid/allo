...
"""PolyBench gramschmidt on upmem -- Tier-2 triangular extension cell (task 008).
...
_TARGET = "upmem"
_RUN_CMD = (
    "python -m pytest tests/pim/upmem/gramschmidt/test_gramschmidt_upmem.py "
    "-p no:cacheprovider -q"
)


def test_gramschmidt_upmem(request):
