...
"""PolyBench gesummv on upmem -- Tier-1 single-output cell (task 005).
...
_TARGET = "upmem"
_RUN_CMD = (
    "python -m pytest tests/pim/upmem/gesummv/test_gesummv_upmem.py "
    "-p no:cacheprovider -q"
)


def test_gesummv_upmem(request):
