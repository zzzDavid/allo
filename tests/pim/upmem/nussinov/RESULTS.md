# nussinov on upmem (SMALL)

- correctness: **PASS** -- canonical MLIR -> portable C matched repository NumPy reference for table (max_abs_err=0, rtol=0.0001, atol=0.0001); ABI packed and gathered a full 64-DPU rank
- reference: examples/polybench/nussinov.py::nussinov_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'N': 180}
- cycles: 794330985
- source: `upmem_cost@1e9f869de726a65f (analytical MLIR operation graph); portable-C functional oracle`
- run_cmd: `python -m pytest tests/pim/upmem/nussinov/test_nussinov_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:36.660302
