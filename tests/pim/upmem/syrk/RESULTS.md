...
- reference: examples/polybench/syrk.py::syrk_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'M': 60, 'N': 80}
- cycles: 2221666
- source: `upmem_cost@1e9f869de726a65f (analytical MLIR operation graph); portable-C functional oracle`
- run_cmd: `python -m pytest tests/pim/upmem/syrk/test_syrk_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:39.653951
