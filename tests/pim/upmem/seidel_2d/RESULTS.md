...
- reference: examples/polybench/seidel_2d.py::seidel_2d_np SMALL_DATASET (validated by `tests/pim/test_upmem_polybench_registry.py`)
- shapes: {'TSTEPS': 40, 'N': 120}
- cycles: 577101719
- source: `upmem_cost@1e9f869de726a65f (analytical MLIR operation graph); portable-C functional oracle`
- run_cmd: `python -m pytest tests/pim/upmem/seidel_2d/test_seidel_2d_upmem.py -p no:cacheprovider -q`
- timestamp: 2026-07-01T09:39:37.798727
