...
"""GEMM compiled explicitly for Samsung HBM-PIM."""
...
_RUN_CMD = "python -m pytest tests/pim/samsung_hbm_pim/gemm/test_gemm_samsung_hbm_pim.py -p no:cacheprovider -q"
_NOTES = "SPMW slice-form GEMM on the 128-PE mapping; genuine fp16 PASS against A@B."
