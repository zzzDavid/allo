...
"""Gram-matrix core compiled explicitly for Samsung HBM-PIM."""
...
_RUN_CMD = "python -m pytest tests/pim/samsung_hbm_pim/gramschmidt/test_gramschmidt_samsung_hbm_pim.py -p no:cacheprovider -q"
_NOTES = "Tier-2 Gram contraction; real REDUCE cycles with honest CYCLES-ONLY numerics."
