...
"""PolyBench gramschmidt on samsung_hbm_pim -- Tier-2 triangular extension cell (task 008).
...
_RUN_CMD = (
    "python -m pytest tests/pim/samsung_hbm_pim/gramschmidt/test_gramschmidt_samsung_hbm_pim.py "
