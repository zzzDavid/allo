...
"""Doitgen contraction compiled explicitly for Samsung HBM-PIM."""
...
_RUN_CMD = "python -m pytest tests/pim/samsung_hbm_pim/doitgen/test_doitgen_samsung_hbm_pim.py -p no:cacheprovider -q"
_NOTES = "Flattened batched contraction with genuine fp16 simulator readback."
