...
"""PolyBench 2mm on Samsung HBM-PIM -- SPMW slice form (spec 05).

AB = A@B ; D = AB@C. A GEMM chain. Each stage slices its P output rows over
mapping=[16,8] via get_wid(). The cell's chain helper threads AB's real readback
into stage2. Co-located leaf-dir workload.
"""
