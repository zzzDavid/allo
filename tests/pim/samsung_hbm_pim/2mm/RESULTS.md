...
- correctness: **CYCLES-ONLY** -- samsung/2mm: run path reports cycles only (no output array); computed at the GEMV design point
...
- timestamp: 2026-06-29T10:56:22.918095
