...
"""PolyBench 2mm on samsung_hbm_pim -- Tier-1 single-output cell (task 005).

Thin cell: build the target from `lib`, run the shared `two_mm` workload through
...
from workloads import two_mm as _wl

_KERNEL = "2mm"
_TARGET = "samsung_hbm_pim"
_RUN_CMD = (
    "python -m pytest tests/pim/samsung_hbm_pim/2mm/test_two_mm_samsung_hbm_pim.py "
