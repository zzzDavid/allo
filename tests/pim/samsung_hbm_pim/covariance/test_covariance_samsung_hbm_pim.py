...
"""Covariance contraction compiled explicitly for Samsung HBM-PIM."""
...
_RUN_CMD = "python -m pytest tests/pim/samsung_hbm_pim/covariance/test_covariance_samsung_hbm_pim.py -p no:cacheprovider -q"
_NOTES = "On-device cdata.T@cdata contraction; host centering/normalization remains off-device."
