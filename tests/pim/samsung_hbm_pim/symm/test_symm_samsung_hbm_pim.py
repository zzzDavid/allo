...
"""SYMM contraction core compiled explicitly for Samsung HBM-PIM."""
...
_RUN_CMD = "python -m pytest tests/pim/samsung_hbm_pim/symm/test_symm_samsung_hbm_pim.py -p no:cacheprovider -q"
_NOTES = (
    "Tier-2 symmetric contraction; real REDUCE cycles with honest CYCLES-ONLY numerics."
)


def test_symm_samsung_hbm_pim(request):
