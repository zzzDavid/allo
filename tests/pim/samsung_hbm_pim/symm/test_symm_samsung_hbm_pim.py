...
"""PolyBench symm on samsung_hbm_pim -- Tier-2 triangular extension cell (task 008).
...
_RUN_CMD = (
    "python -m pytest tests/pim/samsung_hbm_pim/symm/test_symm_samsung_hbm_pim.py "
...
def test_symm_samsung_hbm_pim(request):
    ...
    # (samsung_hbm_pim/symm/workload.py, slice form) by run_cell; STAGES re-read
    # from it.
