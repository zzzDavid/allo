...
"""PolyBench gemver on samsung_hbm_pim -- Tier-1 multi-output cell (task 006).

Thin cell: build the target from `lib`, run the shared multi-stage `gemver`
...
_RUN_CMD = (
    "python -m pytest tests/pim/samsung_hbm_pim/gemver/test_gemver_samsung_hbm_pim.py "
