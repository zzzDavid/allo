# mvt on samsung_hbm_pim (SMALL)

- correctness: **CYCLES-ONLY** -- samsung/mvt: run path reports cycles only (no output array); computed at the GEMV design point
...
- timestamp: 2026-06-29T10:58:57.352674
