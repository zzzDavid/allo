...
"""MVT compiled explicitly for Samsung HBM-PIM."""
...
_RUN_CMD = "python -m pytest tests/pim/samsung_hbm_pim/mvt/test_mvt_samsung_hbm_pim.py -p no:cacheprovider -q"
_NOTES = "Independent A@y1 and A.T@y2 contractions with checked readbacks."


def test_mvt_samsung_hbm_pim(request):
