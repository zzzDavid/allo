...
"""PolyBench trmm compiled explicitly for SK hynix GDDR6-AiM."""
...
_TARGET = "aim"
_RUN_CMD = (
    "python -m pytest tests/pim/aim/trmm/test_trmm_aim.py " "-p no:cacheprovider -q"
)
_NOTES = (
