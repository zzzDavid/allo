...
"""PolyBench syrk compiled explicitly for SK hynix GDDR6-AiM."""
...
_TARGET = "aim"
_RUN_CMD = (
    "python -m pytest tests/pim/aim/syrk/test_syrk_aim.py " "-p no:cacheprovider -q"
)
_NOTES = (
