...
"""PolyBench mvt compiled explicitly for SK hynix GDDR6-AiM."""
...
_TARGET = "aim"
_RUN_CMD = (
    "python -m pytest tests/pim/aim/mvt/test_mvt_aim.py " "-p no:cacheprovider -q"
)
_NOTES = (
