...
"""Canonical ludcmp on the real APU v1 scalar ARC fallback."""
...
_KERNEL = "ludcmp"
_RUN_CMD = (
    "python -m pytest tests/pim/apu_v1/ludcmp/test_ludcmp_apu_v1.py "
    "-p no:cacheprovider -q"
)


@pytest.mark.apu_v1_device
def test_ludcmp_apu_v1(request, apu_v1_device_gate):
