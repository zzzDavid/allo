...
"""Canonical deriche on the real APU v1 scalar ARC fallback."""
...
_KERNEL = "deriche"
_RUN_CMD = (
    "python -m pytest tests/pim/apu_v1/deriche/test_deriche_apu_v1.py "
    "-p no:cacheprovider -q"
)


@pytest.mark.apu_v1_device
def test_deriche_apu_v1(request, apu_v1_device_gate):
