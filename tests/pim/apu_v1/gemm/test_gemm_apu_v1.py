...
"""PolyBench gemm on APU v1 -- Tier-1 REAL-DEVICE cell (task 007).

Thin cell: build the apu_v1 target from `lib`, run the shared `gemm` workload
...
def test_gemm_apu_v1(request, apu_v1_device_gate):
