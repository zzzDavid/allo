...
"""Canonical adi on the real APU v1 scalar ARC fallback."""
...
_KERNEL = "adi"
_RUN_CMD = (
    "python -m pytest tests/pim/apu_v1/adi/test_adi_apu_v1.py " "-p no:cacheprovider -q"
)


@pytest.mark.apu_v1_device
def test_adi_apu_v1(request, apu_v1_device_gate):
