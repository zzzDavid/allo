...
"""Canonical durbin on the real APU v1 scalar ARC fallback."""
...
_KERNEL = "durbin"
_RUN_CMD = (
    "python -m pytest tests/pim/apu_v1/durbin/test_durbin_apu_v1.py "
    "-p no:cacheprovider -q"
)


@pytest.mark.apu_v1_device
def test_durbin_apu_v1(request, apu_v1_device_gate):
