...
"""PolyBench 3mm on APU v1 -- Tier-1 REAL-DEVICE cell (task 007).

Thin cell: build the apu_v1 target from `lib`, run the shared `three_mm` workload
...
def test_three_mm_apu_v1(request, apu_v1_device_gate):
