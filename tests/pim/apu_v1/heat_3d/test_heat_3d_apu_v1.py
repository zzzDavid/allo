...
"""Canonical heat_3d on the real APU v1 scalar ARC fallback."""
...
_KERNEL = "heat_3d"
_RUN_CMD = (
    "python -m pytest tests/pim/apu_v1/heat_3d/test_heat_3d_apu_v1.py "
    "-p no:cacheprovider -q"
)


@pytest.mark.apu_v1_device
def test_heat_3d_apu_v1(request, apu_v1_device_gate):
