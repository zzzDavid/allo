...
"""Canonical floyd_warshall on the real APU v1 scalar ARC fallback."""
...
_KERNEL = "floyd_warshall"
_RUN_CMD = (
    "python -m pytest tests/pim/apu_v1/floyd_warshall/test_floyd_warshall_apu_v1.py "
    "-p no:cacheprovider -q"
)


@pytest.mark.apu_v1_device
def test_floyd_warshall_apu_v1(request, apu_v1_device_gate):
