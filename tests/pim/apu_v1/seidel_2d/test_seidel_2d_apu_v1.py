...
"""Canonical seidel_2d on the real APU v1 scalar ARC fallback."""
...
_KERNEL = "seidel_2d"
_RUN_CMD = (
    "python -m pytest tests/pim/apu_v1/seidel_2d/test_seidel_2d_apu_v1.py "
    "-p no:cacheprovider -q"
)


@pytest.mark.apu_v1_device
def test_seidel_2d_apu_v1(request, apu_v1_device_gate):
