...
"""PolyBench 2mm on APU v1 -- Tier-1 REAL-DEVICE cell (task 007).

Thin cell: build the apu_v1 target from `lib`, run the shared `two_mm` workload
...
def test_two_mm_apu_v1(request, apu_v1_device_gate):
