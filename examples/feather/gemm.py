...
def test_FEATHER_GEMM():
    ...
    if hls.is_available("vitis_hls"):
        ...
        # ALLO_HLS_MODE overrides the default mode. Supported: csyn, hw_emu, hw.
        # "csyn" only runs HLS synthesis (no XRT needed).
        # "hw_emu" runs hardware emulation (needs XRT).
        # "hw" runs on real FPGA hardware (needs XRT + device).
        ...
        if hls_mode == "csyn":
            # csyn mode: just run synthesis, no kernel execution
            hls_mod()
